...
# include this key file (aspera_ssh_bypass_rsa) in the same folder as this python lib
ASPERA_SSH_BYPASS_RSA_NOPASS='aspera_ssh_bypass_rsa.pem'
ASPERA_SSH_BYPASS_ABS_PATH=os.path.join(os.path.dirname(os.path.abspath(__file__)),ASPERA_SSH_BYPASS_RSA_NOPASS)
